...
type _Ctype_struct_AVFormatParameters struct {
	...
	_		[4]byte
	video_codec_id	int32
	audio_codec_id	int32
}
...
func _Cfunc_avcodec_find_encoder(int32) *_Ctypedef_AVCodec
...
func _Cfunc_avcodec_find_decoder(int32) *_Ctypedef_AVCodec
