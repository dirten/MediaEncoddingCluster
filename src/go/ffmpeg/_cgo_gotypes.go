...
type _Ctypedef_SwsFilter _Ctype_struct___3
...
type _Ctypedef_SwsVector _Ctype_struct___4
...
func _Cfunc_avpicture_get_size(uint32, _Ctype_int, _Ctype_int) _Ctype_int
func _Cfunc_CString(string) *_Ctype_char
func _Cfunc_sws_getContext(_Ctype_int, _Ctype_int, uint32, _Ctype_int, _Ctype_int, uint32, _Ctype_int, *_Ctypedef_SwsFilter, *_Ctypedef_SwsFilter, *_Ctype_double) *[0]byte
...
func _Cfunc_av_log_set_level(_Ctype_int)
func _Cfunc_av_guess_format(*_Ctype_char, *_Ctype_char, *_Ctype_char) *_Ctypedef_AVOutputFormat
func _Cfunc_free(unsafe.Pointer)
func _Cfunc_avpicture_alloc(*_Ctypedef_AVPicture, uint32, _Ctype_int, _Ctype_int) _Ctype_int
...
func _Cfunc_avpicture_fill(*_Ctypedef_AVPicture, *_Ctypedef_uint8_t, uint32, _Ctype_int, _Ctype_int) _Ctype_int
