...
namespace org {
  namespace esb {
    namespace web {
      ...
      JobTable::JobTable() :doSome_(new Wt::WCompositeWidget(), "doSome"), Wt::Ext::TableView() {
      ...
      Wt::JSignal<std::string,int>& JobTable::doSome() {
        LOGDEBUG("Wt::JSignal<std::string, int>& JobTable::doSome()");
        return doSome_;
      }
