...
namespace org {
  namespace esb {
    namespace api {
      ...
      JsonSystemHandler::JsonSystemHandler() {
      }

      JsonSystemHandler::~JsonSystemHandler() {
      }

      JSONNode JsonSystemHandler::handle(struct mg_connection *conn, const struct mg_request_info *request_info, db::HiveDb& db, std::string postdata) {
