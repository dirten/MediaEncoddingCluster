    ...
    namespace core {
      ...
      class StorageEngine: public org::esb::core::Plugin {
        public:
          ...
          virtual void writeUnitStream(org::esb::model::Unit & unit,std::ostream&)=0;
          ...
          virtual org::esb::model::Job getJobByUUID(std::string & uuid)=0;
          virtual std::list<org::esb::model::Job> getJobList(int start=0, int count=0)=0;
          ...
          virtual std::list<org::esb::model::OutputFile> getOutputFileList(int start=0, int count=0)=0;
          ...
          virtual std::list<org::esb::model::Profile> getProfileList(int start=0, int count=0)=0;
