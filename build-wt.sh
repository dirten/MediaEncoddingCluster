...
mkdir build
cd build
cmake -DCMAKE_INSTALL_PREFIX=$SRCDIR/$BUILDDIR/wt -DCMAKE_BUILD_TYPE=Release -DSHARED_LIBS=Off -DBOOST_DIR=$SRCDIR/build/boost -DBOOST_VERSION=1_36 -DBOOST_COMPILER=gcc41 .. 
make 
make install
